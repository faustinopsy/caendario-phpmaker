...
class cusuarios_list extends cusuarios {
	...
	function RenderListOptions() {
		...
		$oListOpt->Body = "<input type=\"checkbox\" name=\"key_m[]\" value=\"" . ew_HtmlEncode($this->id_usuario->CurrentValue) . "\" onclick='ew_ClickMultiCheckbox(event);'>";
	...
	function LoadRowValues(&$rs) {
		...
		$this->image->Upload->DbValue = "image/".$rs->fields('image');
	...
	function LoadDbValues(&$rs) {
		...
		$this->image->Upload->DbValue = "image/".$row['image'];
	...
	function RenderRow() {
		...
		$this->image->ViewCustomAttributes = "";
			...
			if ($this->image->UseColorbox) {
				...
				$this->image->LinkAttrs["data-rel"] = "usuarios_x" . $this->RowCnt . "_image";
...
<?php if ($usuarios_list->TotalRecs > 0 || $usuarios->CurrentAction == "gridedit") { ?>
...
<?php if ($usuarios->nome->Visible) { // nome ?>
	...
	<?php } else { ?>
		<th data-name="nome"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuarios->SortUrl($usuarios->nome) ?>',1);"><div id="elh_usuarios_nome" class="usuarios_nome">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $usuarios->nome->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($usuarios->nome->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($usuarios->nome->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($usuarios->name->Visible) { // name ?>
	<?php if ($usuarios->SortUrl($usuarios->name) == "") { ?>
		<th data-name="name"><div id="elh_usuarios_name" class="usuarios_name"><div class="ewTableHeaderCaption"><?php echo $usuarios->name->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="name"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuarios->SortUrl($usuarios->name) ?>',1);"><div id="elh_usuarios_name" class="usuarios_name">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $usuarios->name->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($usuarios->name->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($usuarios->name->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($usuarios->gender->Visible) { // gender ?>
	<?php if ($usuarios->SortUrl($usuarios->gender) == "") { ?>
		<th data-name="gender"><div id="elh_usuarios_gender" class="usuarios_gender"><div class="ewTableHeaderCaption"><?php echo $usuarios->gender->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="gender"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuarios->SortUrl($usuarios->gender) ?>',1);"><div id="elh_usuarios_gender" class="usuarios_gender">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $usuarios->gender->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($usuarios->gender->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($usuarios->gender->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($usuarios->mobile->Visible) { // mobile ?>
	<?php if ($usuarios->SortUrl($usuarios->mobile) == "") { ?>
		<th data-name="mobile"><div id="elh_usuarios_mobile" class="usuarios_mobile"><div class="ewTableHeaderCaption"><?php echo $usuarios->mobile->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="mobile"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuarios->SortUrl($usuarios->mobile) ?>',1);"><div id="elh_usuarios_mobile" class="usuarios_mobile">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $usuarios->mobile->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($usuarios->mobile->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($usuarios->mobile->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($usuarios->designation->Visible) { // designation ?>
	<?php if ($usuarios->SortUrl($usuarios->designation) == "") { ?>
		<th data-name="designation"><div id="elh_usuarios_designation" class="usuarios_designation"><div class="ewTableHeaderCaption"><?php echo $usuarios->designation->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="designation"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuarios->SortUrl($usuarios->designation) ?>',1);"><div id="elh_usuarios_designation" class="usuarios_designation">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $usuarios->designation->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($usuarios->designation->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($usuarios->designation->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($usuarios->image->Visible) { // image ?>
	<?php if ($usuarios->SortUrl($usuarios->image) == "") { ?>
		<th data-name="image"><div id="elh_usuarios_image" class="usuarios_image"><div class="ewTableHeaderCaption"><?php echo $usuarios->image->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="image"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuarios->SortUrl($usuarios->image) ?>',1);"><div id="elh_usuarios_image" class="usuarios_image">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $usuarios->image->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($usuarios->image->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($usuarios->image->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php
...
<span id="el<?php echo $usuarios_list->RowCnt ?>_usuarios_nome" class="usuarios_nome">
...
<a id="<?php echo $usuarios_list->PageObjName . "_row_" . $usuarios_list->RowCnt ?>"></a></td>
	<?php } ?>
	<?php if ($usuarios->name->Visible) { // name ?>
		<td data-name="name"<?php echo $usuarios->name->CellAttributes() ?>>
<span id="el<?php echo $usuarios_list->RowCnt ?>_usuarios_name" class="usuarios_name">
<span<?php echo $usuarios->name->ViewAttributes() ?>>
<?php echo $usuarios->name->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($usuarios->gender->Visible) { // gender ?>
		<td data-name="gender"<?php echo $usuarios->gender->CellAttributes() ?>>
<span id="el<?php echo $usuarios_list->RowCnt ?>_usuarios_gender" class="usuarios_gender">
<span<?php echo $usuarios->gender->ViewAttributes() ?>>
<?php echo $usuarios->gender->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($usuarios->mobile->Visible) { // mobile ?>
		<td data-name="mobile"<?php echo $usuarios->mobile->CellAttributes() ?>>
<span id="el<?php echo $usuarios_list->RowCnt ?>_usuarios_mobile" class="usuarios_mobile">
<span<?php echo $usuarios->mobile->ViewAttributes() ?>>
<?php echo $usuarios->mobile->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($usuarios->designation->Visible) { // designation ?>
		<td data-name="designation"<?php echo $usuarios->designation->CellAttributes() ?>>
<span id="el<?php echo $usuarios_list->RowCnt ?>_usuarios_designation" class="usuarios_designation">
<span<?php echo $usuarios->designation->ViewAttributes() ?>>
<?php echo $usuarios->designation->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($usuarios->image->Visible) { // image ?>
		<td data-name="image"<?php echo $usuarios->image->CellAttributes() ?>>
<span id="el<?php echo $usuarios_list->RowCnt ?>_usuarios_image" class="usuarios_image">
<span>
<?php echo ew_GetFileViewTag($usuarios->image, $usuarios->image->ListViewValue()) ?>
</span>
</span>
</td>
	<?php } ?>
