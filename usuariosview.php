	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id_usuario"] <> "") {
				...
				$this->id_usuario->setFormValue($_POST["id_usuario"]);
...
<?php if ($usuarios->name->Visible) { // name ?>
	<tr id="r_name">
		<td><span id="elh_usuarios_name"><?php echo $usuarios->name->FldCaption() ?></span></td>
...
<?php echo $usuarios->name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($usuarios->gender->Visible) { // gender ?>
	<tr id="r_gender">
		<td><span id="elh_usuarios_gender"><?php echo $usuarios->gender->FldCaption() ?></span></td>
...
<?php echo $usuarios->gender->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($usuarios->mobile->Visible) { // mobile ?>
	<tr id="r_mobile">
		<td><span id="elh_usuarios_mobile"><?php echo $usuarios->mobile->FldCaption() ?></span></td>
...
<?php echo $usuarios->mobile->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($usuarios->designation->Visible) { // designation ?>
	<tr id="r_designation">
		<td><span id="elh_usuarios_designation"><?php echo $usuarios->designation->FldCaption() ?></span></td>
...
<?php echo $usuarios->designation->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($usuarios->image->Visible) { // image ?>
	<tr id="r_image">
		<td><span id="elh_usuarios_image"><?php echo $usuarios->image->FldCaption() ?></span></td>
		<td data-name="image"<?php echo $usuarios->image->CellAttributes() ?>>
<span id="el_usuarios_image">
<span>
<?php echo ew_GetFileViewTag($usuarios->image, $usuarios->image->ViewValue) ?>
</span>
</span>
</td>
	</tr>
