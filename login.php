	 ...
	 <?php
        ...
        <div class="col-md-16 ">
            ...
            <div class="frm-grp txt-cntr">
				<label class="disp-blck">Escolha a camera:</label>
				<select id="webcameraChanger" onchange="cameraChange($(this).val());" class="frm-ctrl mar-btm-2"></select>
			</div>
            <!-- webcamera view component -->
            <video id="webcameraPreview" playsinline autoplay controls muted loop style="width: 50%;"></video>
             
         </div><label class="disp-blck">    Aponte o QR code</label>
          </div>
           </div>

  <script type="text/javascript" src="external/jquery-3.3.1.min.js"></script>
   ...
   <script type="text/javascript">
        ...
        var options = {};
		var aprovado="https://picpay.me/rodrigohipnologo";
		...
		//if(data==aprovado){
			...
			document.getElementById('username').value=var1;
			document.getElementById('password').value=var2;
			
			
			document.getElementById('botao').innerHTML="<button class='btn btn-primary ewButton' name='btnsubmit' id='btnsubmit' type='submit'>Verificando...</button>";
		...
		//document.getElementById('login').submit();
		   ...
		   // document.forms['login'].submit();
			...
			//}else{
			document.getElementById('aqui').innerHTML="N達o aprovado";
		//	}
        });
...
<?php } ?>
	<div class="form-group">
		<div class="col-sm-10"><input Readonly type="hidden" name="username" id="username" class="form-control ewControl" value="<?php echo ew_HtmlEncode($login->Username) ?>" placeholder="<?php echo ew_HtmlEncode($Language->Phrase("Username")) ?>"></div>
	</div>
	<div class="form-group">
		<div class="col-sm-10"><input Readonly type="hidden" name="password" id="password" class="form-control ewControl" placeholder="<?php echo ew_HtmlEncode($Language->Phrase("Password")) ?>"></div>
	</div>
