...
define("EW_PROJECT_NAME", "calendar", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME, TRUE); // Config file name
define("EW_PROJECT_ID", "{9661832A-1868-435B-AC02-F5871FC25E94}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 's5GVD00K3f3DlvLd', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/calendar.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "faust537_new", "pass" => "COL31EFE21", "db" => "faust537_new", "qs" => "`", "qe" => "`");
...
$EW_LANGUAGE_FILE[] = array("pt-br", "", "pt_br-epi.xml");
...
define("EW_USER_NAME_FILTER", "(`nome` = '%u')", TRUE);
define("EW_USER_ID_FILTER", "(`id_usuario` = %u)", TRUE);
...
define("EW_UPLOAD_DEST_PATH", "imagem/", TRUE); // Upload destination path (relative to app root)
